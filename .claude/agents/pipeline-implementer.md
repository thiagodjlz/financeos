...
2. Confira o estado do git (`git status`). Se ja existir uma branch `feature/issue-<numero>-<slug>`, faca checkout nela. Caso contrario, crie a partir da branch atual: `git checkout -b feature/issue-<numero>-<slug>`.
