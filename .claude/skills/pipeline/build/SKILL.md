---
name: build
description: Etapa 5 da esteira de implementacao - gera o build (jar backend, bundle frontend) e gera build-report.md.
...
2. **Use o retorno do agente** para mostrar ao usuario o resultado (backend/frontend) e os caminhos dos artefatos gerados.
