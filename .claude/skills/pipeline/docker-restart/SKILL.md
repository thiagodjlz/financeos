---
name: docker-restart
description: Etapa 6 da esteira de implementacao - atualiza o ambiente de teste local (stack Docker) com o codigo da feature, para o usuario validar antes do commit, e gera docker-report.md.
...
2. **Use o retorno do agente** para mostrar ao usuario o resultado e os enderecos do ambiente (`http://localhost` para a tela, `http://localhost:8080/docs` para a API).
