---
name: quality-check
description: Etapa 4 da esteira de implementacao - roda os testes de backend e frontend e gera quality-report.md.
...
2. **Use o retorno do agente** para mostrar ao usuario o resultado de cada checagem (backend/frontend/build). Nao releia `quality-report.md` para isso.
