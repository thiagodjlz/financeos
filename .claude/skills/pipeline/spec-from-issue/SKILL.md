...
6. Depois que o agente retornar, leia o `spec.md` gerado e mostre ao usuario um resumo curto: titulo, dominios identificados, numero de criterios de aceite, e quaisquer "pontos em aberto".
