...
6. Termine informando explicitamente: "Revise `specs/<numero>-<slug>/spec.md`. Quando estiver de acordo, rode `/pipeline:plan-implementation <numero>`." Nao rode o proximo comando sozinho.
