...
// Classe sem @TestSecurity de classe: a anotacao de classe de ReleaseNotesResourceTest autentica
// tudo e nao permitiria exercitar nem o 401 nem um usuario sem permissao da tela.
@QuarkusTest
class ReleaseNotesSecurityTest {

    private static final String RESTRICTED_USER_ID = "00000000-0000-0000-0000-0000000009c1";
    private static final String RESTRICTED_PROFILE_ID = "00000000-0000-0000-0000-0000000009c2";
    private static final String RESTRICTED_USER_EMAIL = "teste-novidades-sem-permissao@financeos.local";
    ...
    void createRestrictedUser() {
        QuarkusTransaction.requiringNew().run(() -> {
            profileRepository.getEntityManager()
                    ...
                    .setParameter(2, "Teste novidades sem permissao")
                    .executeUpdate();
            ...
            userRepository.getEntityManager()
                    ...
                    .setParameter(2, "Teste novidades")
    ...
    private void grantReleaseNotes(boolean canView) {
        QuarkusTransaction.requiringNew().run(() -> profileRepository.getEntityManager()
                .createNativeQuery("""
                        ...
                        values (cast(?1 as uuid), 'RELEASE_NOTES', ?2, false, false, false)
                        """)
                .setParameter(1, RESTRICTED_PROFILE_ID)
    ...
    void shouldDenyProfileWithoutReleaseNotesRow() {
        given()
                .when().get("/release-notes")
                .then()
                .statusCode(403)
    ...
    void shouldDenyProfileWithReleaseNotesViewFalse() {
        grantReleaseNotes(false);
    ...
    void shouldAllowProfileWithReleaseNotesView() {
        grantReleaseNotes(true);
